<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactUS.aspx.cs" Inherits="EliteFamilyDental.ContactUS" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
   <title>www.EliteFamilyDental.com | Contacts</title>
    <!-- metas -->
		<meta charset="utf-8">
		<meta name="author" content="www.EliteFamilyDental.com | Contacts | Rehab | EliteFamilyDental| Ashoka Rehab">
		<meta name="keywords" content="www.EliteFamilyDental.com | Contacts | Rehab | EliteFamilyDental| Ashoka Rehab">
		<meta name="description" content="www.EliteFamilyDental.com | Contacts | Rehab | EliteFamilyDental| Ashoka Rehab">
    ...
    <div>
        <div class="page">
				...
				<nav class="main-nav">
					<ul>
						...
						<li>
                        	...
                        	<li>
							<a href="MakeanAppointment3.aspx"><i class="fa fa-plus"></i>Appointment</a>
						</li>
                        <li>
			...
			<!--			<li class="right">
						...
						<li>
							<a href="ContactUS.aspx" class="active"><i class="fa fa-plus"></i>Contacts</a>
						</li>
					</ul>
				</nav>
				<!--/ main nav -->
			...
			<main class="page-content">
				<div class="grid-row">
					...
					<section class="map">
                        ...
                        <%--<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d30444.381169174438!2d78.53682399999995!3d17.481351999999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb9b096fabfc87%3A0xcc268cceb84ffbb8!2sAshoka+Rehab!5e0!3m2!1sen!2sin!4v1423315743157" width="100%" height="400px" frameborder="0" style="border:0"></iframe>--%>
                        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15232.074215449757!2d78.4312502!3d17.3628402!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x2cc3f3243399103d!2sELITE+FAMILY+DENTAL!5e0!3m2!1sen!2sin!4v1554989332380!5m2!1sen!2sin" width="100%" height="400px" frameborder="0" style="border:0"></iframe>
				...
				<div class="grid-row">
					<div class="grid-col grid-col-9">
						...
						<article class="feedback">
							...
							<%--<form action="http://html.creaws.com/EliteFamilyDental/php/contact-send.php" id="contactform">--%>
								<fieldset>
									<div class="clearfix">
										<div class="input">
											<label>Your name:</label>
											<input type="text" id="txtname" runat="server" name="name">
<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtname" ErrorMessage="Name Missing" ForeColor="Red"></asp:RequiredFieldValidator>
										</div>
										<div class="input">
											<label>Your email:</label>
											<input type="text" id="txtemail" runat="server"  name="email">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtemail" ErrorMessage="Email id Missing" ForeColor="Red"></asp:RequiredFieldValidator>
										</div>
									</div>
									<div class="clearfix">
										<div class="input">
											<label>Phone:</label>
											<input type="text" id="txtPhone" runat="server"  name="category">
                                           
										</div>
										<div class="input">
											<label>Subject:</label>
											<input type="text" id="txtSubject" runat="server"  name="subject">
                                            
										</div>
									</div>
									<label>Message:</label>
									<textarea rows="6" name="message" id="txtmessage" runat="server" ></textarea>
                                     <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtmessage" ErrorMessage="Message Missing" ForeColor="Red"></asp:RequiredFieldValidator>
									<div class="clearfix captcha">
											...
											<asp:Button ID="BtnSubmit" runat="server"  class="button" Text="Submit" OnClick="BtnSubmit_Click"></asp:Button>
						...
						<section class="widget widget-contacts">
                            ...
                            Attapur,Hyderabad-500 048.</li>
								...
								<!--		<li><i class="fa fa-phone"></i>Call us: 9966012643</li>
                                        <li><i class="fa fa-phone"></i>Call us: 8500412643</li>-->
										<li><i class="fa fa-envelope"></i>E-mail: Sangananad.gavle@gmail.com</li>
									</ul>
								</dd>
