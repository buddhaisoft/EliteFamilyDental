<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MakeanAppointment.aspx.cs" Inherits="AshokaRehab.MakeanAppointment" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
 		<title>www.BuddhaiSoft.com - Responsive Medical and Health Template</title>
		
		<!-- metas -->
		<meta charset="utf-8">
		<meta name="author" content="http://Buddhaisoft">
...
<body>
    ...
    <div>
				...
				<nav class="main-nav">
					<ul>
						<li>
							...
							<ul>
								<li>
									<a href="index-2.html">Medical Style</a>
									<ul>
										<li class="text">
											<h2>Main Campus</h2>
											<hr>
						...
						<li class="right">
							<a href="index-2.html" class="active"><i class="fa fa-plus"></i>Features</a>
							<ul>
								...
								<li>
									...
									<ul>
										...
										<li><a href="page-with-sidebar.html" class="active">Page with Sidebar</a></li>
		...
		<%--	<form id="quick-search" class="quick-search">
				...
				<div class="grid-row">					
					<div class="grid-col grid-col-9">
						...
						<section>	
							...
							<div class="wpb_text_column wpb_content_element">
								<div class="wpb_wrapper">			
									...
									facilisis eu elit.
									Pellentesque pellentesque orci quam, nec tempus nibh congue ut. Pellentesque tempus vehicula lectus eget tempor. Donec suscipit enim dui, ut 
									sagittis orci rhoncus id. Mauris pharetra orci arcu, sed varius nulla lobortis. Ut non molestie nulla. Nulla nec rutrum tortor, in fermentum nisl.accumsan pulvinar scelerisque tincidunt, adipiscing eget risus. 
									Nunc elit dolor, feugiat in faucibus luctus, vulputate at dui. Morbi condimentum augue in nisl gravida iaculis. Donec feugiat accumsan est, 
									vitae aliquam nibh hendrerit in. Phasellus felis tellus, aliquet et malesuada id.
									</p>
									<p>Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi 
									nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt 
									...
									aliquid ex ea commodi consequatur?
									 ...
									 et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid 
						...
						<section class="widget">	
							<div class="widget-title">Why Choose Ashoka?</div>
										...
										<div class="wpb_text_column wpb_content_element">
											<div class="wpb_wrapper">			
												<ul class="ul1">
													...
													<li>Massa faucibus accumsan placerat dui.</li>
													<li>Maecenas facilisis lacinia metus sit amet.</li>
												</ul>
											</div>
										</div>
									</div>
					...
					<div class="grid-col grid-col-3">
						...
						<section class="widget widget-appointment">
							<div class="widget-title">Make an Appointment</div>
								...
								<div class="row">
									...
									<input type="text" ID="txtfullname" runat="server" placeholder="Full Name"><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtfullname" ErrorMessage="RequiredFieldValidator"></asp:RequiredFieldValidator>

									<i class="fa fa-user"></i>
								</div>
								<div class="row">
									<input type="tel"  ID="txtphone" runat="server"  placeholder="Phone Nomber">
									<i class="fa fa-phone"></i>
								</div>
								<div class="row">
									<input type="email"  ID="txtemail" runat="server"  placeholder="Email Address">
									<i class="fa fa-envelope"></i>
								</div>
								<div class="row">
									<input type="text"  ID="txtdate" runat="server"  placeholder="Appointment Date">
									<i class="fa fa-calendar"></i>
								</div>
								<div class="row">
									<textarea cols="30" rows="5" placeholder="Message"  ID="txtcomments" runat="server" ></textarea>
									<i class="fa fa-align-left"></i>
								</div>
						<%--	<button class="button button-primary">Send Message</button>--%>
                            
                            <asp:Button ID="btnSendmsg" runat="server" Text="Send Message" CssClass="button button-primary" OnClick="btnSendmsg_Click"></asp:Button><br />
							<asp:Label ID="lblmsg" runat="server" Font-Bold="True" Font-Italic="True" Font-Size="Larger" ForeColor="Blue"></asp:Label>
						</section>
						<!--/ appointment -->
						...
						<section class="widget widget-sevices">
							...
							<ul>
								<li><i class="fa fa-bookmark"></i><a href="#a"><i class="fa fa-angle-right"></i>Cardiothoracic Surgery</a></li>
								<li><i class="fa fa-bookmark"></i><a href="#a"><i class="fa fa-angle-right"></i>Cardiovascular Diseases</a></li>
								<li><i class="fa fa-bookmark"></i><a href="#a"><i class="fa fa-angle-right"></i>Ophthalmology</a></li>
								<li><i class="fa fa-bookmark"></i><a href="#a"><i class="fa fa-angle-right"></i>Dermatology</a></li>
								<li><i class="fa fa-bookmark"></i><a href="#a"><i class="fa fa-angle-right"></i>General Surgery</a></li>
								<li><i class="fa fa-bookmark"></i><a href="#a"><i class="fa fa-angle-right"></i>Consultative & Diagnostic</a></li>
							</ul>
						</section>
						<!--/ categories -->
						<!-- text -->
			...
			<!-- copyrights -->
			<div class="copyrights">Copyrights ©2014: www.BuddhaiSoft.com - Responsive Medical and Health Template</div>
			<!--/ copyrights -->
