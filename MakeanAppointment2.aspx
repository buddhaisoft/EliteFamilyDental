<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MakeanAppointment2.aspx.cs" Inherits="AshokaRehab.MakeanAppointment2" %>
        ...
        <!-- page header -->
			<header class="page-header main-page">
				...
				<section id="logo" class="logo">
					<div>
						<a href="index-2.html"><img src="img/blue/logo6.png"  alt="Ashoka Rehab"></a>
					</div>
				</section>
				<!--/ logo -->
				...
				<nav class="main-nav">
					<ul>
								...
								<li>
									...
									<ul>
										<li class="text">
											...
											<hr>
											203-284-2818<br>ashokarehab@gmail.com
						...
						<li>
                        	...
                        	<li>
							<a href="MakeanAppointment.aspx"><i class="fa fa-plus"></i>Appointment</a>
						</li>
                        <li>
						...
						<li>
							<a href="news-two-columns.htm"><i class="fa fa-plus"></i>News</a>
						<!--	<ul>
			...
			<!--			<li class="right">
				...
				<nav id="mobile-main-nav" class="mobile-main-nav">
					...
					<ul>
								...
								<li>
									...
									<ul>
										<li class="text">
											...
											<hr>
											<p>203-284-2818<br>ashokarehab@gmail.com</p>
						...
						<li>
							<a href="news-two-columns.htm">News</a>
						<!--	<ul>
								<li><a href="news-four-columns.html">Four columns</a></li>
								<li><a href="news-three-columns.html">Three columns</a></li>
								<li><a href="news-two-columns.html">Two columns</a></li>
					...
					<div class="grid-col grid-col-3">
						...
						<section class="widget widget-comments">
							...
							<div id="comments-carousel" class="owl-carousel">
								<div class="item">
									<ul>
										<li>
											<img src="pic/doctor-1.jpg" alt="Elite Family Dental | Best Dental Clinic ATTAPUR | Dental Clinic in Attapur | Dentist In Attapur | Dental Hospital | Top 1 Dentists | Dental Surgeons in Attapur | Best Dental Clinic| ELITE FAMILY DENTAL ATTAPUR">
											<div class="author"><a href="#">Amanda Kliens</a></div>
											<p>Blandit vel velit nec, varius imperdiet dolor donec.<br><span class="date">Jul 27th, 2014</span></p>
										</li>
										<li>
											<img src="pic/doctor-2.jpg" alt="Elite Family Dental | Best Dental Clinic ATTAPUR | Dental Clinic in Attapur | Dentist In Attapur | Dental Hospital | Top 1 Dentists | Dental Surgeons in Attapur | Best Dental Clinic| ELITE FAMILY DENTAL ATTAPUR">
											<div class="author"><a href="#">Henrietta Borjas</a></div>
											<p>Blandit vel velit nec, varius imperdiet dolor donec.<br><span class="date">Jul 24th, 2014</span></p>
										</li>
										<li>
											<img src="pic/doctor-3.jpg" alt="Elite Family Dental | Best Dental Clinic ATTAPUR | Dental Clinic in Attapur | Dentist In Attapur | Dental Hospital | Top 1 Dentists | Dental Surgeons in Attapur | Best Dental Clinic| ELITE FAMILY DENTAL ATTAPUR">
											<div class="author"><a href="#">Normand Wehling</a></div>
											<p>Blandit vel velit nec, varius imperdiet dolor donec.<br><span class="date">Jul 20th, 2014</span></p>
										</li>
										<li>
											<img src="pic/doctor-4.jpg" alt="Elite Family Dental | Best Dental Clinic ATTAPUR | Dental Clinic in Attapur | Dentist In Attapur | Dental Hospital | Top 1 Dentists | Dental Surgeons in Attapur | Best Dental Clinic| ELITE FAMILY DENTAL ATTAPUR">
											<div class="author"><a href="#">Trevor Smith</a></div>
											<p>Blandit vel velit nec, varius imperdiet dolor donec.<br><span class="date">Jul 11th, 2014</span></p>
										</li>
									</ul>
								</div>
								<div class="item">
								...
								<div class="item">
									<ul>
										...
										<li>
											...
											<div class="author"><a href="#">Amanda Kliens</a></div>
											<p>Blandit ve
											l velit nec, varius imperdiet dolor donec.<br><span class="date">Jul 27th, 2014</span></p>
										</li>
									</ul>
								</div>
							</div>
						...
						<section class="widget widget-departments">
							...
							<dl>
								...
								<dt><i class="fa fa-wheelchair"></i>Rehabilitation Studio</dt>
								<dd>Sed purus purus, tincidunt eget malesuada et, molestie ut eros. Fusce blandit, sapien eu sollicitudin consectetur, ligula tellus pulvinar. Urna, quis facilisis magna dolor ac lacus.</dd>
							</dl>
						</section>
						<!--/ departments -->
						...
						<section>	
							...
							<div class="wpb_text_column wpb_content_element">
								<div class="wpb_wrapper">			
									<img src="pic/our-phylosophy.jpg" width="260" height="246" alt="Elite Family Dental | Best Dental Clinic ATTAPUR | Dental Clinic in Attapur | Dentist In Attapur | Dental Hospital | Top 1 Dentists | Dental Surgeons in Attapur | Best Dental Clinic| ELITE FAMILY DENTAL ATTAPUR" class="alignleft">
									<p class="capitalized">Nullam convallis volutpat nunc, gravida vestibulum mauris interdum et. Nuncv tortor facilisis quis. Donec tempor erat vel scelerisque posuere. Nam elementum elit eget tellus faucibus euismod. Aliquam turpis nibh, dictum eu consequat ac, facilisis eu elit.<br><br>Pellentesque pellentesque orci quam, nec tempus nibh congue ut. Pellentesque tempus vehicula lectus eget tempor. Donec suscipit enim dui, ut sagittis orci rhoncus id. Mauris pharetra orci arcu, sed varius nulla lobortis.</p>
									<p>Ut non molestie nulla. Nulla nec rutrum tortor, in fermentum nisl.accumsan pulvinar scelerisque tincidunt, adipiscing eget risus. Nunc elit dolor, feugiat in faucibus luctus, vulputate at dui. Morbi condimentum augue in nisl gravida iaculis. Donec feugiat accumsan est, vitae aliquam nibh hendrerit in. Phasellus felis tellus, aliquet et malesuada id.
, luctus ac purus. In quis ligula non ipsum posuere dignissim. In leo ligula, nunc elit dolor, feugiat in faucibus luctus, vulputate at dui.</p>
									<p>Ut non molestie nulla. Nulla nec rutrum tortor, in fermentum nisl.accumsan pulvinar scelerisque tincidunt, adipiscing eget risus. Nunc elit dolor, feugiat in faucibus luctus, vulputate at dui. Morbi condimentum augue in nisl gravida iaculis. Donec feugiat accumsan est, vitae aliquam nibh hendrerit in. Phasellus felis tellus, aliquet et malesuada id.
									, luctus ac purus. In quis ligula non ipsum posuere dignissim. In leo ligula, nunc elit dolor, feugiat in faucibus luctus, vulputate at dui.</p>
								</div>
							</div>
						...
						<section class="widget">	
							<div class="widget-title">Why Choose AshokaRehab?</div>
										...
										<div class="wpb_text_column wpb_content_element">
											<div class="wpb_wrapper">
												<ul class="ul1">
													...
													<li>Curabitur a laoreet erat nulla odio.</li>
													<li>Massa faucibus accumsan placerat dui.</li>
													<li>Maecenas facilisis lacinia metus sit.</li>
													<li>Suspendisse pharetra libero.</li>
												</ul>
											</div>
										</div>
						...
						<div class="wpb_content_element">
							<div class="testimonial">
								<div class="clearfix">
									...
									<p>Sed purus purus, tincidunt eget malesuada et, molestie ut eros. Fusce blandit, sapien eu sollicitudin consectetur, ligula tellus pulvinar. Urna, quis facilisis magna dolor ac lacus. Mauris congue nec nisi sit amet malesuada. Vivamus sodales nunc et pulvinar bibendum. Morbi quis erat non odio suscipit.</p>								
								</div>
						...
						<section class="widget">	
							...
							<p class="capitalized">Vestibulum scelerisque leo sed sem sagittis. Nunc elit dolor, feugiat in faucibus luctus, vulputate at dui.  Donec lacinia suscipit magna, et pulvinar tortor facilisis quis. Donec tempor erat vel scelerisque posuere. Nam elementum elit eget tellus faucibus euismod. Aliquam turpis nibh, dictum eu consequat ac, facilisis eu elit.</p><br>
										...
										<div class="wpb_text_column wpb_content_element">
											<div class="wpb_wrapper">			
												<ul class="ul2">
													...
													<li><a href="#">Maecenas facilisis lacinia metus sit.</a></li>
												</ul>
											</div>
										</div>
									</div>
										...
										<div class="wpb_text_column wpb_content_element">
											<div class="wpb_wrapper">
												<ul class="ul2">
													...
													<li><a href="#">Maecenas facilisis lacinia metus sit.</a></li>
													<li><a href="#">Suspendisse pharetra libero.</a></li>
													<li><a href="#">Curabitur a laoreet erat nulla.</a></li>
												</ul>
											</div>
										</div>
									</div>
				...
				<div class="grid-row">
					<div class="grid-col grid-col-3">
						...
						<section class="widget-alt last-news">
							...
							<div class="widget-title">AshokaRehab</div>
							<ul>
